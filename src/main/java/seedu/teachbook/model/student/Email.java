...
public class Email {
    ...
    public static final String MESSAGE_CONSTRAINTS = "Emails should be of the format local-part@domain and adhere to"
     ...
     * @return {@code true} is the given string is a valid email.
     */
